...
| `slmp::highlevel::PlcProfile::IqL` | MELSEC iQ-L | `slmp::FrameType::Frame4E` | `slmp::CompatibilityMode::iQR` | Uses iQ-R string-address rules with the iQ-L range family. |
| `slmp::highlevel::PlcProfile::MxF` | MELSEC MX-F profile | `slmp::FrameType::Frame4E` | `slmp::CompatibilityMode::iQR` | Uses the MX-F address profile and range family. |
| `slmp::highlevel::PlcProfile::MxR` | MELSEC MX-R profile | `slmp::FrameType::Frame4E` | `slmp::CompatibilityMode::iQR` | Uses the MX-R address profile and range family. |
