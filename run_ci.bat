...
echo [2/6] Building live read smoke tool...
...
echo [3/6] Checking live read smoke tool usage...
call "%LIVE_READ_EXE%" >nul 2>nul
if errorlevel 3 goto fail
if not errorlevel 2 goto fail

echo [4/6] Validating API reference...
...
echo [5/6] Running host tests...
call "%TEST_EXE%"
if errorlevel 1 goto fail

echo [6/6] Running socket integration test...
