...
echo [2/7] Building Arduino transport tests...
...
echo [3/7] Running Arduino transport tests...
call "%ARDUINO_TRANSPORT_TEST_EXE%"
if errorlevel 1 goto fail

echo [4/7] Building live read smoke tool...
...
echo [5/7] Checking live read smoke tool usage...
call "%LIVE_READ_EXE%" >nul 2>nul
if errorlevel 3 goto fail
if not errorlevel 2 goto fail

echo [6/7] Validating API reference...
